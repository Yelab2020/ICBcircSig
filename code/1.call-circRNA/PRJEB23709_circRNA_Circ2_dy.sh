...
dir_circ='/work/dy/project/circRNA/RNA_xiangya/Circ'
mkdir -p ${dir_circ}/${sample}
fa='/work/dy/software/RNA/circRNA/call_cirRNA/ref/fa/gencode_v28_genome.fa'
bwa='/work/dy/software/RNA/circRNA/call_cirRNA/bin/bwa'
...
circ2='/work/dy/software/miniconda3/envs/RNAseq_py37/bin/CIRCexplorer2'
unmap_bwa_sam=${dir_circ}/${sample}/${sample}'_unmapped_bwa.sam'
${circ2} parse -t BWA -b ${dir_circ}/${sample}/${sample}'_circ2_result.txt' ${unmap_bwa_sam} > ${dir_circ}/${sample}/${sample}'_test.parse.log'
ann_ref='/work/dy/software/RNA/circRNA/call_cirRNA/ref/hg38_ref_Circ2.txt'
