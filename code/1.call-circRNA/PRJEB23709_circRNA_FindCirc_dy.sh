...
echo $var
sample=${var}  #%_1.fq.gz*};
dir_alignment='/work/dy/project/circRNA/RNA_xiangya/alignment_ht2-2'
dir_findcirc='/work/dy/project/circRNA/RNA_xiangya/FindCirc'
...
unmap2anch='/work/dy/software/RNA/circRNA/call_cirRNA/find_circ/unmapped2anchors.py'
unmap_anchor=${dir_findcirc}/${sample}/${sample}'_unmapped_anchor.fastq'
python2 ${unmap2anch} ${unmap} > ${unmap_anchor}
bt2='/work/dy/software/RNA/circRNA/call_cirRNA/bin/bowtie2'
bt2_index='/work/dy/software/RNA/circRNA/call_cirRNA/ref/fa/hisat2_index/bowtie2_index/gencode_v28'
...
maxlen='/work/dy/software/RNA/circRNA/call_cirRNA/find_circ/maxlength.py'
